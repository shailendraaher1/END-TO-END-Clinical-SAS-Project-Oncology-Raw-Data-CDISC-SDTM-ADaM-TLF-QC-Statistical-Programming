...
3. **3. ADaM Analysis Design Derivation** - ADaM analysis design and derivation documentation
4. **4. ADaM Datasets** - Derive ADaM analysis-ready datasets using SAS
5. **5. TLF Specification and Shell Design** - TLF blueprints and statistical shell designs
6. **6. ADaM Mapping For TLF** - Map ADaM datasets for TLF generation
